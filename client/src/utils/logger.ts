...
- setLevel(level): Set global log level (NONE, ERROR, WARN, INFO, DEBUG)
- setComponentLevel(component, level): Set component-specific log level
- resetConfig(): Reset to default configuration
- getConfig(): Get current configuration
- toggleTimestamps(): Toggle timestamp display
- help(): Show this help message

Examples:
- loggerControl.setLevel('ERROR')
- loggerControl.setComponentLevel('api', 'DEBUG')
      `);
    }
  };
  
  console.info('Logger control panel available at window.loggerControl. Type loggerControl.help() for usage.');
} 