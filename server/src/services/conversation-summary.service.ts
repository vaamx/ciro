...
import { OpenAIService, openAIService, ChatMessage as OpenAIChatMessage } from './openai.service';
...
export class ConversationSummaryService {
  ...
  constructor(openAIService?: OpenAIService) {
    ...
    this.openAI = openAIService || OpenAIService.getInstance();
  }
  ...
  private async shouldSummarizeConversation(messages: any[]): Promise<boolean> {
    try {
      ...
      let summarizeThreshold = this.defaultOptions.maxTokenCount || 4000; // Default fallback
