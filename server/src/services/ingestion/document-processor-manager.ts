...
// import { DocumentProcessorService } from '../data-processing/document-processor.service'; // TODO: Update path after refactor
...
export class DocumentProcessorManager {
  ...
  private async processJob(job: ProcessingJob): Promise<void> {
    ...
    try {
      ...
      // await this.documentProcessorService.processDocument( // TODO: Reinstate after refactor
      //   job.filePath,
      //   job.fileType as FileType,
      //   job.dataSourceId,
      //   job.metadata
      // );
      this.logger.warn('TODO: Reinstate call to documentProcessorService.processDocument'); // Placeholder
      // TEMPORARY: Simulate success for now
