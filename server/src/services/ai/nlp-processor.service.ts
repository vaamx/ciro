...
export class NlpProcessorService {
  ...
  private readonly requirementAnalyzer: RequirementAnalyzerService;
  ...
  private constructor(
    ...
    private readonly temporalAnalyzerService: TemporalAnalyzerService,
    private readonly requirementAnalyzerService: RequirementAnalyzerService,
    ) {
    this.queryClassifier = this.queryClassifierService;
    this.entityExtractor = this.entityExtractorService;
    this.temporalAnalyzer = this.temporalAnalyzerService;
    this.requirementAnalyzer = this.requirementAnalyzerService;
  }
